...
#define LCD_LED        	GPIO_Pin_2  //MCU_PB9--->>TFT --BL D2
...
#define	LCD_LED_SET  	LCD_CTRLD->BSRR=LCD_LED   
...
#define	LCD_LED_CLR  	LCD_CTRLD->BRR=LCD_LED 
...
void Lcd_SS_Clear(u16 x_start,u16 y_start,u16 w , u16 h,u16 Color) ;  
